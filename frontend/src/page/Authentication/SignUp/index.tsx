...
import { CustomTextField, CustomSelect, colors } from "libs/ui";
  ...
  return (
    ...
    >
      ...
      >
        ...
        {step === 0 && (
          <>
            <Typography variant="h3" sx={{ margin: "40px auto 1rem auto" }}>
              Thông tin cá nhân
            </Typography>
        ...
        {step === 2 &&
          RoleField.map((item: Partial<SignUpFormProps>) => {
            return (
              <>
                <Typography variant="h3" sx={{ margin: "40px auto 1rem auto" }}>
                  {item.header}*{" "}
                ...
                >
                  ...
                  <MenuItem value={"shop"}>Chủ quán</MenuItem>
                </CustomSelect>
              </>
            );
          })}
