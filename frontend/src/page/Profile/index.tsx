        ...
        <Grid item lg={12} xs={4}>
          ...
          >
            ...
            <p style={{ textAlign: "justify", color: "black" }}>
              Một khi tài khoản bị xóa, tất cả dữ liệu của bạn sẽ bị mất và
              không thể khôi phục tài khoản. Hãy lưu ý kỹ trước khi xác nhận xóa
              tài khoản.
            </p>
            <Button variant="text" size="large" style={{ display: "flex" }}>
              Xoá tài khoản
            </Button>
          </Box>
        </Grid>
